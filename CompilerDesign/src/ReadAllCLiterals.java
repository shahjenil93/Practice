...
public class ReadAllCLiterals {
    private static boolean res,d,valid,chckForFloat;
    private static int counter, begin, end;
    private static int[] delimiters = {37,38,42,43,44,45,47,59,60,61,62,91,93,124,125};
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException {
        ...
        try ( Scanner s = new Scanner(new BufferedReader(new FileReader("/Users/jenil/Documents/Programming/Practice/Geeks4Geeks/Arrays/FindMaxSum_C.c"))) ) {
            while(s.hasNext()){
                String str = s.next();
